          ...
          <div className=" py-16">
            ...
            <div className="flex gap-4">
              <div className="bg-[#f2f8f8] flex gap-8 rounded-lg py-3 px-4 justify-center items-center">
                <FaMinus className="text-[#f5953b]" />
                <p className="font-semibold">0</p>
                <FaPlus className="text-[#f5953b]" />
              </div>
              <button className="text-white text-sm font-semibold bg-[#f5953b] btn-cart py-3 flex gap-3 rounded-xl">
                {" "}
                <span>
